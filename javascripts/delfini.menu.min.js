...
(function(a){a(document).ready(function(){a("ul.dropdown").wrap('<div class="dropdownWrapper" />').after(function(){var c=a(this);a(this).trigger("dropdownReady");if(c.children("li.selected").attr("data-value")&&c.children("li.selected").attr("data-value")!=undefined&&c.children("li.selected").attr("data-value")!=""){var b=c.children("li.selected").attr("data-value")}else{var b=c.children("li.selected").text()}return'<input name="'+c.attr("data-name")+'" type="hidden" value="'+b+'"/>'});a("body").delegate("ul.dropdown","click",function(){var b=a(this);var e=b.offset().left;var d=b.offset().top;var c=a(document).height();b.addClass("open");if(d+b.height()>c){d-=(d+b.height()+20)-c}b.css({left:e+"px",position:"absolute",top:d+"px"});b.trigger("menuOpened")});a(document).click(function(b){if(!a(b.target).is("ul.dropdown")&&!a(b.target).parents().is("ul.dropdown")){a("ul.dropdown").removeClass("open").removeAttr("style")}});a("body").delegate("ul.dropdown li","click",function(d){var c=a(this);var f=c.parent();var b=true;if(f.hasClass("open")){if(c.parent().children("li.selected").is(c)){b=false}c.addClass("reservedItemCurrentlySelcted").siblings("li.selected").removeClass("selected").siblings("li.reservedItemCurrentlySelcted").removeClass("reservedItemCurrentlySelcted").addClass("selected");f.removeClass("open").removeAttr("style");d.stopPropagation();if(c.attr("data-value")&&c.attr("data-value")!=undefined&&c.attr("data-value")!=""){f.siblings("input").val(c.attr("data-value"))}else{f.siblings("input").val(c.text())}currentMenu.trigger("menuItemSelected");if(b){currentMenu.trigger("newMenuItemSelected")}}})})})(jQuery);